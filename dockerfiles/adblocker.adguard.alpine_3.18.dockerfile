...
LABEL\
	maintainer="Arijit Bhowmick <arijit_bhowmick@outlook.com>" \
	org.opencontainers.image.authors="Arijit Bhowmick <arijit_bhowmick@outlook.com>" \
	...
	org.opencontainers.image.title="AD Blocker | AdGuard Home" \
	org.opencontainers.image.url="https://adguard.com/en/adguard-home/overview.html" \
	org.opencontainers.image.vendor="AD Blocker | ADGUARD" \
